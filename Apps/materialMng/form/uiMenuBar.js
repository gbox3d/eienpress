    ...
    <div class="ui-view w3-bar w3-light-grey">
        ...
        <div class="w3-dropdown-click">
            ...
            <div class="w3-dropdown-content w3-bar-block w3-card-4">
                ...
                <a href="#" class="w3-bar-item w3-button" data-mid="chgEnv" >change enviroment map</a>
            </div>
        </div>
        <div class="w3-dropdown-click">
            ...
            <div class="w3-dropdown-content w3-bar-block w3-card-4">
                ...
                <a href="#" class="w3-bar-item w3-button" data-mid='reload' >reload</a>
                <a href="#" class="w3-bar-item w3-button" data-mid='delete' >delete file</a>
            </div>
        </div>
    </div>
    `;
