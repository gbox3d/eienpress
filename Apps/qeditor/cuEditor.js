...
export default function setup({
    ...
    return new Elvis({
        ...
        setup: async function () {
            ...
            //확장함수
            scope.setEnableKeyInput = function (bEnable) {
                this.bEnableKeyInput = bEnable;
            }
            ...
            scope.searchParentDummy = function (obj) {
            ...
            scope.loadObject = async function ({
                _id,
                onProgress,
            ...
            ////////////////////////////////////////////////////////////////////////////////
            //space
            scope.initSpace = function ({ title, description }) {
            ...
            scope.fromJsonByUrl = async function ({ url, onProgress }) {
            ...
            scope.toGltf = function ({ title, description }) {
            ...
            scope.setCursor = function (object) {
            ...
            scope.makeTrigerNode = function (data) {
            ...
            scope.dropObject = function (parentObject) {
            ...
            scope.addSpace = function (object) {
            ...
            scope.setupSpaceDummy = async function (space_dummy, onProgress) {
            ...
            scope.updateCamera = function (delta) {
            ...
            try {
                ...
                // this.space_dummy = new THREE.Group();
                // this.space_dummy.name = 'space_dummy';
                // this.root_dummy.add(this.space_dummy);
        ...
        event: {
            ...
            onUpdate: function (event) {
                ...
                this.updateCamera(event.deltaTick);
                ...
                if (this.orbitControl.enabled && this.bSetupComplete) { //오빗컨트롤이 활성화 상태일때만..
                    ...
                    if (intersects.length > 0) {
                        ...
                        if (this.cubeCorsor.visible && this.cubeCorsor.children.length > 0) { //오브잭트 내려놓기 
                            ...
                            const _dummy = this.searchParentDummy(intersects[0].object);


                            if (this.select_node !== _dummy) {

                                let objType = _dummy.userData.type
            ...
            onKeyUp: function (event) {
                ...
                if (this.bEnableKeyInput === true) {
                    ...
                    //             this.dropObject(this.intersectObjects[0].object);
                    //         }
                    //         break;
                    //     default : 
                    //         break;
