...
///////
class zeroWalkerObject extends THREE.Object3D {
	constructor({
		engine,
		playerWidth = 3.5,
		playerHeight = 15,
		...
		this.type = 'zeroWalkerObject';
		this.isZeroWalkerObject = true;
...
export { dummyObject, gameObject, walkerGameObject , zeroWalkerObject};